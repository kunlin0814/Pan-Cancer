...
# Tumor
time bwa aln -t 4 $reference/canFam3.fa $dataT/SRR7780923_1.fastq > ${result}/SRR7780923_1.sai
time bwa aln -t 4 $reference/canFam3.fa $dataT/SRR7780923_2.fastq > ${result}/SRR7780923_2.sai
...
# Normal
time bwa aln -t 4 $reference/canFam3.fa $dataN/SRR7780922_1.fastq > ${result}/SRR7780922_1.sai
time bwa aln -t 4 $reference/canFam3.fa $dataN/SRR7780922_2.fastq > ${result}/SRR7780922_2.sai
