...
mutect2_folder='/scratch/kh31516/Original_Mammary/store/PRJNA489159/Mutect2'
vaf_out='/scratch/kh31516/Original_Mammary/store/PRJNA489159/MT_VAF/Mutect2'

while read line1 line2 line3
do
    #echo $line1
    mkdir -p $vaf_out/$line1
    cd $mutect2_folder/${line1}
    
    python $scripts/Mutect2_5Steps_filtering.py \
    $mutect2_folder/${line1}/PON_DbSNP_filtered-${line1}_MuTect2_GATK4.vcf \
    $mutect2_folder/${line1}/PON_DbSNP_filtered-${line1}_MuTect2_GATK4.vcf \
    $mutect2_folder/${line1}/${line1}_vaf_before.txt \
    $mutect2_folder/${line1}/${line1}_vaf_after.txt \
    $mutect2_folder/${line1}/${line1}_whyout.txt
    
    rm PON_DbSNP_filtered-${line1}_MuTect2_GATK4.vcf-PASS_filteredMut
...
do
    ...
    python $scripts/Mutect2_5Steps_filtering.py \
    $mutect2_folder/${line1}/$line1/PON_DbSNP_filtered-${line1}_MuTect2_GATK4.vcf \
    $mutect2_folder/${line1}/$line1/PON_DbSNP_filtered-${line1}_MuTect2_GATK4.vcf \
    $mutect2_folder/${line1}/$line1_vaf_before.txt \
    $mutect2_folder/${line1}/$line1_vaf_after.txt \
    $mutect2_folder/${line1}/$line1_whyout.txt
