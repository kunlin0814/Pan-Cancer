#!/bin/bash
#SBATCH --job-name=single_end_RNAseq         # Job name (single_end_RNAseq)
...
#SBATCH --output=single_end_RNAseq.%j.out    # Standard output log
#SBATCH --error=single_end_RNAseq.%j.err     # Standard error log
### This script is for single end RNA-seq

### INDEX the genome for STAR and HISAT2 respectively first ###

genomeDir='/work/szlab/dog_resouces/source/STAR'
data='/scratch/kh31516/Melanoma/RNA-seq/data/SRR7779460'
result='/scratch/kh31516/Melanoma/RNA-seq/results/SRR7779460'
hisat_source='/work/szlab/dog_resouces/source/HISAT2'
source='/work/szlab/dog_resouces/source'
