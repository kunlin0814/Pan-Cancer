#!/bin/bash
#PBS -N Trimmomatic-i_03A6-WES-25
...
result='/scratch/kh31516/Pan_cancer/glioma/results/Trimmomatic_WES/BQ25/results/i_03A6' #
...
TdataN='/scratch/kh31516/Pan_cancer/glioma/results/Trimmomatic_WES/BQ25/data/SRR10351810'
TdataT='/scratch/kh31516/Pan_cancer/glioma/results/Trimmomatic_WES/BQ25/data/SRR10351811'
...
$TdataN/SRR10351810_lane1_forward_paired.fq.gz $TdataN/SRR10351810_lane1_forward_unpaired.fq.gz \
$TdataN/SRR10351810_lane1_reverse_paired.fq.gz $TdataN/SRR10351810_lane1_reverse_unpaired.fq.gz \
ILLUMINACLIP:/usr/local/apps/eb/Trimmomatic/0.36-Java-1.8.0_144/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:25 MINLEN:36



time java -jar /usr/local/apps/eb/Trimmomatic/0.36-Java-1.8.0_144/trimmomatic-0.36.jar PE -threads 4 \
$dataT/SRR10351811_1.fastq.gz $dataT/SRR10351811_2.fastq.gz \
$TdataT/SRR10351811_lane1_forward_paired.fq.gz $TdataT/SRR10351811_lane1_forward_unpaired.fq.gz \
$TdataT/SRR10351811_lane1_reverse_paired.fq.gz $TdataT/SRR10351811_lane1_reverse_unpaired.fq.gz \
ILLUMINACLIP:/usr/local/apps/eb/Trimmomatic/0.36-Java-1.8.0_144/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:25 MINLEN:36
...
perl $reference/annovar/convert2annovar.pl -format vcf4old $result/i_03A6_rg_added_sorted_dedupped_removed.MuTect.vcf-PASS \
> $result/i_03A6_rg_added_sorted_dedupped_removed.MuTect.vcf-PASS-avinput

# annovar annotate
perl $reference/annovar/annotate_variation.pl --buildver canFam3 $result/i_03A6_rg_added_sorted_dedupped_removed.MuTect.vcf-PASS-avinput $reference
