...
# ## with DbSNP
# java -Xmx32g -cp  $scripts/ DbSNP_filtering \
...
${scripts}/strelka-2.9.2.centos6_x86_64/bin/configureStrelkaSomaticWorkflow.py \
...
python2 $scripts/Limit_vcf_to_CDS.py $strelka_out/results/variants/somatic.indels.vcf.gz $reference/Canis_familiaris.CanFam3.1.99.gtf-chr1-38X-CDS-forDepthOfCoverage.interval_list
...
# add gene name
python2 $scripts/Add_GeneName_N_Signature.py $strelka_out/results/variants/somatic.indels.vcf_canFam3.1.99_CDS-PASS-avinput.exonic_variant_function \
