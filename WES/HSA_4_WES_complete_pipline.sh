#!/bin/bash
#SBATCH --job-name=HSA_4_WES         # Job name (HSA_4_WES)
...
#SBATCH --output=HSA_4_WES.%j.out    # Standard output log
#SBATCH --error=HSA_4_WES.%j.err     # Standard error log
...
Normal_Run='SRR10260888'
Tumor_Run='SRR10260877'
SampleName='HSA_4'
results='/scratch/kh31516/Pan_cancer/HSA/results/'${Bioproject}'/'${SampleName}'' #
reference='/work/szlab/Lab_shared_PanCancer/source' 
dataN='/scratch/kh31516/Pan_cancer/HSA/data/'${Bioproject}'/'${SampleName}'/'${Normal_Run}
dataT='/scratch/kh31516/Pan_cancer/HSA/data/'${Bioproject}'/'${SampleName}'/'${Tumor_Run}
MuTect2_source='/work/szlab/Lab_shared_PanCancer/source/Mutect2'
MuTect_out='/scratch/kh31516/Pan_cancer/HSA/store/'${Bioproject}'/Mutect/'${SampleName}''
MuTect2_out='/scratch/kh31516/Pan_cancer/HSA/store/'${Bioproject}'/Mutect2/'${SampleName}''
Germline_out='/scratch/kh31516/Pan_cancer/HSA/store/'${Bioproject}'/Germline/'${SampleName}''
