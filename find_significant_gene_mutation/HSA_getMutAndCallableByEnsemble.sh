#!/bin/bash
#SBATCH --job-name=HSA_ensembl_callable         # Job name (HSA_ensembl_callable)
...
#SBATCH --output=HSA_ensembl_callable.%j.out    # Standard output log
#SBATCH --error=HSA_ensembl_callable.%j.err     # Standard error log
...
mutect_folder="/scratch/kh31516/Pan_cancer/Burair_filtering3/HSA_Broad/Mutect"
ensembl_source="/home/kh31516/kh31516_Lab_Share_script/Retro_gene_source/Pan_cancer_sign_target_ensembl_location.txt"
wig_callable="/home/kh31516/kh31516_Lab_Share_script/Retro_gene_source/HSA_wig_samples.txt"
...
## Broad HSA
output_folder='/scratch/kh31516/Pan_cancer/Burair_filtering3/HSA_Broad/Mutect'
wig_folder="/scratch/tw71066/All_NEW_WES/PRJNA552034-HSA/Mutation/new_mutect_results"
mutect_folder="/scratch/kh31516/Pan_cancer/Burair_filtering3/HSA_Broad/Mutect"
total_file='/scratch/kh31516/Pan_cancer/HSA/source/PRJNA552034-HSA-Normal-Tumor-pair'
