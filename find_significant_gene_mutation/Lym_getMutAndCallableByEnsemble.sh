#!/bin/bash
#SBATCH --job-name=Lym_ensembl_callable         # Job name (Lym_ensembl_callable)
...
#SBATCH --output=Lym_ensembl_callable.%j.out    # Standard output log
#SBATCH --error=Lym_ensembl_callable.%j.err     # Standard error log
...
mutect_folder="/scratch/kh31516/Pan_cancer/Burair_filtering3/LYM/Mutect"
ensembl_source="/home/kh31516/kh31516_Lab_Share_script/Retro_gene_source/Pan_cancer_sign_target_ensembl_location.txt"
wig_callable="/home/kh31516/kh31516_Lab_Share_script/Retro_gene_source/Lym_wig_samples.txt"
...
mutect_folder="/scratch/kh31516/Pan_cancer/Burair_filtering3/LYM/Mutect"
output_folder='/scratch/kh31516/Pan_cancer/Burair_filtering3/LYM/Mutect'
wig_folder="/scratch/baa20876/workDir/pancancer/WES/PRJNA247493/lymphoma/results/Mutect_Mar25"
