#!/bin/bash
#SBATCH --job-name=OM_ensembl_callable         # Job name (OM_ensembl_callable)
...
#SBATCH --output=OM_ensembl_callable.%j.out    # Standard output log
#SBATCH --error=OM_ensembl_callable.%j.err     # Standard error log
...
output_folder='/scratch/kh31516/Pan_cancer/Burair_filtering3/OM_cross_spcs/Mutect'
wig_folder="/scratch/kh31516/Original_Melanoma/store/PRJEB12081/new_Mutect1"
