#!/bin/bash
#SBATCH --job-name=OSA_ensembl_callable         # Job name (OSA_ensembl_callable)
...
#SBATCH --output=OSA_ensembl_callable.%j.out    # Standard output log
#SBATCH --error=OSA_ensembl_callable.%j.err     # Standard error log
...
mutect_folder="/scratch/kh31516/Pan_cancer/Burair_filtering3/OSA_Broad/Mutect"
ensembl_source="/home/kh31516/kh31516_Lab_Share_script/Retro_gene_source/Pan_cancer_sign_target_ensembl_location.txt"
wig_callable="/home/kh31516/kh31516_Lab_Share_script/Retro_gene_source/OSA_wig_samples.txt"
...
# mutect results from Burair_filtering3
mutect_folder='/scratch/kh31516/Pan_cancer/Burair_filtering3/OSA_TGen/Mutect'
...
## Broad OSA
output_folder='/scratch/kh31516/Pan_cancer/Burair_filtering3/OSA_Broad/Mutect'
wig_folder="/scratch/baa20876/workDir/pancancer/WES/PRJNA247493/osteosarcoma/Mutect_Mar25_results"
mutect_folder="/scratch/kh31516/Pan_cancer/Burair_filtering3/OSA_Broad/Mutect"
total_file='/scratch/kh31516/Pan_cancer/Osteo/source/Bur_osteo_pair'
...
## Tgen OSA
output_folder='/scratch/kh31516/Pan_cancer/Burair_filtering3/OSA_TGen/Mutect'
wig_folder="/scratch/jlw87619/PanK9cancer/Osteosarcoma_PRJNA525883-WXS/results_SG"
mutect_folder='/scratch/kh31516/Pan_cancer/Burair_filtering3/OSA_TGen/Mutect'
total_file='/scratch/kh31516/Pan_cancer/Osteo/source/Tgen_TrueN_Tpairs_WES.txt'
